      ...
      servers = {
        ["*"] = {
          ...
          keys = {
            ...
            { "<leader>ca", function() vim.lsp.buf.code_action() end, desc = "Code Action", mode = { "n", "x" }, has = "codeAction" },
            -- { "<leader>cc", function() vim.lsp.codelens.run() end, desc = "Run Codelens", mode = { "n", "x" }, has = "codeLens" },
            -- { "<leader>cC", function() vim.lsp.codelens.refresh() end, desc = "Refresh & Display Codelens", mode = { "n" }, has = "codeLens" },
